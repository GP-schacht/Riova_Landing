        ...
        <section id="mision" className="relative py-16 my-8">
            ...
            <Container variant="default" className="py-20 bg-[#f5f0e8]">  {/* crema orgánico */}
                ...
                <div className="flex justify-center mb-8">
                    <span className="block w-12 h-1 rounded-full bg-[#3B5287]" />
                </div>
                ...
                <div
                    ...
                    `}
                >
                    <h2 className="text-5xl md:text-6xl font-bold text-[#19233a] leading-tight">
                        Nuestra{' '}
                        <span className="text-[#3B5287]">Vision</span>
                    </h2>
                </div>
                ...
                <div
                    ...
                    `}
                >
                    <p className="text-[#212e4d] text-lg leading-relaxed">
                ...
                <div className="flex justify-center mt-10">
                    <span className="block w-6 h-1 rounded-full bg-[#5CA8A1]" />
                </div>
